...
class $149c1bd638913645$export$8c6ee871e681f0f4 {
    ...
    constructor({ securityWorker: securityWorker , secure: secure , format: format , ...axiosConfig } = {}){
        this.instance = (0, $hgUW1$axios).create({
            ...axiosConfig,
    ...
    request = async ({ secure: secure , path: path , type: type , query: query , format: format , body: body , ...params })=>{
        ...
        if (type === $149c1bd638913645$export$e2e108cbe2e4f865.FormData && body && body !== null && typeof body === "object") body = this.createFormData(body);
        let headers = {
