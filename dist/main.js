...
class $882b6d93070905b3$export$8c6ee871e681f0f4 {
    ...
    contentFormatters = {
        [$882b6d93070905b3$export$e2e108cbe2e4f865.Json]: (input)=>input !== null && (typeof input === "object" || typeof input === "string") ? JSON.stringify(input) : input,
        [$882b6d93070905b3$export$e2e108cbe2e4f865.FormData]: (input)=>Object.keys(input || {}).reduce((formData, key)=>{
        ...
        [$882b6d93070905b3$export$e2e108cbe2e4f865.UrlEncoded]: (input)=>this.toQueryString(input)
    };
    ...
    request = async ({ body: body , secure: secure , path: path , type: type , query: query , format: format , baseUrl: baseUrl , cancelToken: cancelToken , ...params })=>{
        ...
        const payloadFormatter = this.contentFormatters[type || $882b6d93070905b3$export$e2e108cbe2e4f865.Json];
